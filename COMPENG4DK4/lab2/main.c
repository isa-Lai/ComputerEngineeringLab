...
main(void)
{
  ...
  while ((random_seed = RANDOM_SEEDS[j++]) != 0) {
    ...
    data.number_of_packets_processeds[0] = 0;
    data.number_of_packets_processeds[1] = 0;
    data.number_of_packets_processeds[2] = 0;
    data.accumulated_delay = 0.0;
    data.accumulated_delays[0] = 0.0;
    data.accumulated_delays[1] = 0.0;
    data.accumulated_delays[2] = 0.0;
    ...
    data.buffer[0] = fifoqueue_new();
    data.buffer[1] = fifoqueue_new();
    data.buffer[2] = fifoqueue_new();
    data.link[0]   = server_new();
    data.link[1]   = server_new();
    data.link[2]   = server_new();
