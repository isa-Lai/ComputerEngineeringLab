...
namelookup = ["enable_btb","perfect_btb"]
...
def main():
 ...
 for rateindex in range(3):
  # for nameindex in range(2):
   #edit params.in
  paramtemplate = open("params41.tem","r")
  paramin = open("params41.in","w")
 ...
 # write to file
 resultFile = os.getcwd()+"/BTB_impact.csv"
 print("write to " + resultFile)
 with open(resultFile,"w") as f:
  #write first line
  f.write("BTB; Execution Time\n")
