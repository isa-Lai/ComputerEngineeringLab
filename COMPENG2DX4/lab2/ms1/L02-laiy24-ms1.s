...
Loop
			LDR R1,[R0]            
			AND R2,R1,#2_00001111	;only check the 0-3 bit in port M
			CMP R2,R3			;check if inputs are 1011
			BEQ Unlocked_State
			BNE Locked_State
...
Locked_State                    
	...
	MOV R4,#2_00000001		;D2 is on, D1 is off
	STR R4,[R5]
	B Loop
	
Unlocked_State
	LDR R5, =GPIO_PORTN_DATA_R
	MOV R4,#2_00000010		;D1 is on, D2 is off
	STR R4, [R5]
	B Loop
